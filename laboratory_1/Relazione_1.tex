...
\title{
		textbf{Relazione attività di laboratorio}\\
...
\begin{Large}
	\begin{equation}
  		{t_r}= 5.5(\pm 0,00055 rdg \pm0,04 FSO)\mu s \pm200ps %TODO arrotondare
	\end{equation}
\end{Large}\\
...
\begin{Large}
	\begin{equation}
  		{t_f}= 5.7(\pm 0,00057 rdg \pm0,04 FSO)\mu s \pm200ps %TODO arrotondare
	\end{equation}
\end{Large}\\
...
\begin{Large}
	\begin{equation}
  		{t_{r_{10x}}}= 975(\pm 0,0975 rdg \pm10 FSO)ns \pm200ps %TODO arrotondare
	\end{equation}
\end{Large}\\
...
\begin{Large}
	\begin{equation}
  		{t_{r_{R_{10x}}}}= 1.3(\pm 0,00013 rdg \pm10 FSO)\mu s \pm200ps %TODO arrotondare
	\end{equation}
\end{Large}\\
...
\begin{Large}
	\begin{equation}
  		{f_s}= 1(\pm 0,001 rdg \pm4 FSO)ns \pm200ps %TODO SU QUESTO SONO MOLTO "INCERTO"
	\end{equation}
\end{Large}\\
